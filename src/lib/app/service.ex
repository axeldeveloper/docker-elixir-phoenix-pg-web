defmodule App.Service do
  ...
  """
  def get_service!(id), do: Repo.get!(Services, id)
  ...
  """
  def update_service(%Services{} = service, attrs) do
    service
    |> Services.changeset(attrs)
    |> Repo.update()
  end
  ...
  """
  def delete_service(%Services{} = service) do
    Repo.delete(service)
  end
  ...
  """
  def change_service(%Services{} = service, attrs \\ %{}) do
    Services.changeset(service, attrs)
  end
end
